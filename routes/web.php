...
Route::group(['namespace' => "Main"], function () {
    ...
    Route::get("/optina_need/{post}", [PostController::class,"showNeed"])->name('main.optina.need');
    ...
    Route::get("/programs", "StudyplanController")->name('main.programs');
    ...
    Route::get("/recommendations", [PagesController::class,"advice"])->name('main.recommendations');
    ...
    Route::get("/recommendations/r-exhibitions/", [PagesController::class,"museum"])->name('main.r-exhibitions');
    Route::get("/theaters", [PagesController::class,"theaters"])->name('main.theaters');
    Route::get("/recommendations/r-theatres/", [PagesController::class,"theaters"])->name('main.r-theatres');
    ...
    Route::get("/summer_reading/summer", [SummerReading::class,"index"])->name('main.summer');
    ...
    Route::get("/old", function (){
        return redirect('http://old.gymnasia-radonezh.ru/');
    });
