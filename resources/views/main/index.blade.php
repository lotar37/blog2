            ...
            <div id="edicaLandingHeaderCarousel" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators ml-3">
                    ...
                    @foreach($carouselPosts as $carouselPost)
                        <li data-target="#edicaLandingHeaderCarousel"
                            style="font-weight: bold; font-size: 24px; color:#36c59e;"
                            data-slide-to="{{ $loop->index }}" class="{{ $loop->index == 0 ? 'active' : ''}}"> &nbsp;&nbsp;&nbsp;&nbsp;<>
                        </li>
                        ...
                        <div class="carousel-item {{ $loop->first ? " active" : ""}}">
                            <div class="row">
                                ...
                                <div class="col-md-6 carousel-img-wrapper">
                                    <img src="{{ asset("storage/" . $carouselPost->mainpage_image) }}"
                                         alt="carousel-img" class="img-fluid img-shadow"
                                         height="375px">
                                </div>
                            </div>
                        </div>
        ...
        <section class="edica-footer-banner-section">
            ...
            <div class="container">
                <div class="row" data-aos="fade-up"
                     style="background: #fafafa;padding:30px;border-radius: 1rem; border:1px solid lightgrey;max-width:110%;">
                    <div class="col-md-5">
                        <img src="{{ asset("assets/images/goschool.jpg") }}" alt=""
                             style="max-height: 300px;max-width:100%;border-radius: 2rem;">
                    </div>
...
{{--                            </div>--}}
                            ...
                            @if($sys_role() == 0)
                                ...
                                <div class="text-center">
                                    <a href="{{ route("main.admission") }}" class="btn btn-secondary btn-lg text-white">ПОДРОБНЕЕ</a>
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 landing-blog-post" data-aos="fade-right">
                        ...
                        <h4 class="blog-post-title"><a href="{{ route('main.circles.show', 1 )}}"
                                                       class="blog-post-link ">Хор</a></h4>
                    ...
                    <div class="col-md-2 landing-blog-post" data-aos="fade-down">
                        ...
                        <h4 class="blog-post-title"><a href="{{ route('main.circles.show', 2 )}}"
                                                       class="blog-post-link ">Математика</a></h4>
                    ...
                    <div class="col-md-2 landing-blog-post" data-aos="fade-up">
                        ...
                        {{--                            <p class="blog-post-category">{{ $categories->find($post->category_id)->title }}</p>--}}
                        <h4 class="blog-post-title"><a href="{{ route('main.circles.show', 6 )}}"
                                                       class="blog-post-link">Валяние</a></h4>
                    ...
                    <div class="col-md-2 landing-blog-post" data-aos="fade-down">
                        ...
                        <h4 class="blog-post-title"><a href="{{ route('main.circles.show', 4 )}}"
                                                       class="blog-post-link">Каллиграф</a></h4>
                    ...
                    <div class="col-md-2 landing-blog-post" data-aos="fade-left">
                        ...
                        <h4 class="blog-post-title"><a href="{{ route('main.circles.show', 3 )}}"
                                                       class="blog-post-link ">ОФП</a></h4>
    ...
    <section class="edica-landing-section edica-landing-testimonials aos-init aos-animate mt-0 mb-4 pb-0"
             data-aos="fade-up" style="background: #d3f6f1">
        <div class="container">
            ...
            <div id="edicaLandingTestimonialCarousel" class="carousel slide landing-testimonial-carousel"
                ...
                <ol class="carousel-indicators" style="height:10rem;">
                    ...
                    @foreach($reports as $report)
                        <li data-target="#edicaLandingTestimonialCarousel" data-slide-to="{{ $loop->index }}"
    ...
    <div class="container">
        ...
        <section class="edica-landing-section edica-landing-blog">
            ...
            <div class="row">
                            ...
                            <div class="accordion" id="edicaAboutFaqCollapse" role="tablist"
                                ...
                                @foreach($answers as $answer)
                                    <div class="card" data-aos="fade-up" data-aos-delay="200">
                                        ...
                                        <div id="edicaAboutFaqContent{{ $loop->index }}" class="collapse in"
                                             role="tabpanel"
                                             aria-labelledby="edicaAboutFaq{{ $loop->index }}">
                                            <div class="card-body ml-2 font-italic text-gray my-1"
                                                 style="border-radius: 1rem;border:1px solid lightgray;">
                                                {!! $answer->answer  !!}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-3 sidebar pt-3 align-content-center"
                     style="border:1px solid lightgrey;background:#eeeeee;border-radius: 1rem;">
                    <h5 class="">Новости</h5>
